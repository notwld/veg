...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    brand: Schema.Attribute.Enumeration<
      ['designtech360', 'mizetechnologies', 'cicada']
    >;
...
export interface ApiVegetableVegetable extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    stock_quantity: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    unit: Schema.Attribute.Enumeration<['g', 'kg', 'piece', 'bunch']> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::vegetable.vegetable': ApiVegetableVegetable;
